...
/* harmony default export */ __webpack_exports__["a"] = (function () {
  ...
  for (var i = 1; i < arguments.length; i++) {
    ...
    if (src !== null) {} else if (src.constructor === Array) {
      for (var _i = 0; _i < src.length; _i++) {
        if (src[_i] !== undefined && target[_i] !== src[_i] && target !== src[_i]) {
          target[_i] = src[_i];
        }
      }
    ...
    if (src.constructor === Array) {
      for (var index = 0; index < src.length; index++) {
        if (src[index] !== undefined && target[index] !== src[index] && target !== src[index]) {
          if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(src[index]) === 'object') {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_merge_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_mergeDeep_js__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_utils_js__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__methods_js__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__xTreeItem_vue__ = __webpack_require__(91);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__xTree_vue__ = __webpack_require__(77);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_merge_js__ = __webpack_require__(26);
...
function _initOptions(options) {
  ...
  var opt = mergeDeep({}, defOptions, options);
...
function _getSubTree(arrayIn, parent, opt) {
  ...
  for (var i = 0; i < arrayIn.length; i++) {
    if (arrayIn[i].nodeId == parent.id) {
      temp = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_merge_js__["a" /* default */])({}, arrayIn[i]);
  ...
  switch (type) {
    ...
    case 'merge':
      ...
      for (var index = 0; index < data.length; index++) {
        clone[index] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_merge_js__["a" /* default */])({}, data[index]);
      }
...
var update = __webpack_require__(39)("096f012b", content, false);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(39)("62fa652b", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
